...
✎﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏
 ...
 ׄPutra Bot By Putra Store
 Jangan Lupa Patuhi Rules
 Bot Eror? Report ke Owner
...
ikyy.sendMessage(from, loli, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                    ikyy.sendMessage(from, { contentText: `${menu}`, footerText: 'Jika Button Di Bawah Tidak Muncul, silahkan Ketik  !command', buttons: [{ buttonId: `!command`, buttonText: { displayText: '☰ COMMAND' }, type: 1 },{ buttonId: `!owner`, buttonText: { displayText: '☰ OWNER BOT' }, type: 1 },{ buttonId: `!sewabot`, buttonText: { displayText: '☰  SEWA BOT' }, type: 1 },{ buttonId: `!owner`, buttonText: { displayText: 'OWNER 👑' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'f':
case 'lock':
 ikymemek = {
...
`
 ...
 Putra Store︎`, imageMessage: imageMsg,
   ...
   case 'command':
               list = []
               listmenu = [`allmenu`,`groupmenu`,`photoxy`,`makermenu`,`ephoto`,`randomimage`,`wibu2`,`storymenu`,`porno`,`randomtext`,`islammenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`gcmikel`,`sewabot`]
               listmenuu = [`All Menu Bot`,`Menu Group`,`Photo Oky`,`Image Maker`,`Ephoto Menu`,`Random Image`,`Nsfw Anime`,`Movie&Story`,`18+ Menu`,`RandomText`,`Islam Menu`,`Wibu Menu`,`Sticker Menu`,`Owner Command`,`Game Menu`,`For Fun Menu`,`Downloader`,`Info Menu`,`Menu Lainnya`,`OwnerBot`,`Official Group`,`Rent this Bot`]
               nombor = 1
               startnum = 0
...
//------------------< Lainnya >-------------------
        ...
        case 'info':  // Jangan Di Ubah Plise
               urlinfo = 'https://telegra.ph/file/7f3047e94d431d40df7ce.jpg'
