...
let errorImg = 'https://i.ibb.co/wNXF41F/IMG-20211226-WA0001.jpg'
...
│•🦈 𝐆𝐫𝐨𝐮𝐩 𝐁𝐨𝐭 : https://bit.ly/3EsZPEL
╰──────────────
...
│• き⃟🦈 *${prefix}islammenu*
│• 
│• き⃟🦈 *${prefix}randomteks*
│• 
│• き⃟🦈 *${prefix}moviemenu*
│• 
│• き⃟🦈 *${prefix}randomimage*
│• 
│• き⃟🦈 *${prefix}ephoto*
│• 
│• き⃟🦈 *${prefix}photoky*
...
ikyy.sendMessage(from, loli, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                    ikyy.sendMessage(from, { contentText: `${menu}`, footerText: 'Jika Button Di Bawah Tidak Muncul, silahkan Ketik  !command', buttons: [{ buttonId: `!command`, buttonText: { displayText: 'LIST MESSAGE' }, type: 1 },{ buttonId: `!store`, buttonText: { displayText: '🛒 STORE' }, type: 1 },{ buttonId: `!sewabot`, buttonText: { displayText: '🏷️ SEWA BOT' }, type: 1 },{ buttonId: `!owner`, buttonText: { displayText: 'OWNER 👑' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'f':
case 'lock':
 ikymemek = {
...
き⃟🦈 ${prefix}blackpink text
き⃟🦈 ${prefix}neon text
き⃟🦈 ${prefix}greenneon text
き⃟🦈 ${prefix}advanceglow text
き⃟🦈 ${prefix}futureneon text
き⃟🦈 ${prefix}sandwriting text
き⃟🦈 ${prefix}sandsummer text
き⃟🦈 ${prefix}sandengraved text
き⃟🦈 ${prefix}metaldark text
き⃟🦈 ${prefix}neonlight text
き⃟🦈 ${prefix}holographic text
き⃟🦈 ${prefix}text1917 text
き⃟🦈 ${prefix}minion text
き⃟🦈 ${prefix}deluxesilver text
き⃟🦈 ${prefix}newyearcard text
き⃟🦈 ${prefix}bloodfrosted text
き⃟🦈 ${prefix}halloween text
き⃟🦈 ${prefix}jokerlogo text
き⃟🦈 ${prefix}fireworksparkle text
き⃟🦈 ${prefix}natureleaves text
き⃟🦈 ${prefix}bokeh text
き⃟🦈 ${prefix}toxic text
き⃟🦈 ${prefix}strawberry text
き⃟🦈 ${prefix}box3d text
き⃟🦈 ${prefix}roadwarning text
き⃟🦈 ${prefix}breakwall text
き⃟🦈 ${prefix}icecold text
き⃟🦈 ${prefix}luxury text
き⃟🦈 ${prefix}cloud text
き⃟🦈 ${prefix}summersand text
き⃟🦈 ${prefix}horrorblood text
き⃟🦈 ${prefix}thunder text
き⃟🦈 ${prefix}pornhub text1 text2
き⃟🦈 ${prefix}glitch text1 text2
き⃟🦈 ${prefix}avenger text1 text2
き⃟🦈 ${prefix}space text1 text2
き⃟🦈 ${prefix}ninjalogo text1 text2
き⃟🦈 ${prefix}marvelstudio text1 text2
き⃟🦈 ${prefix}lionlogo text1 text2
き⃟🦈 ${prefix}wolflogo text1 text2
き⃟🦈 ${prefix}steel3d text1 text2
き⃟🦈 ${prefix}wallgravity text1 text2
 `
...
━━━━━━━ •♬• ━━━━━━━
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `Owner`},type:1},{buttonId: `${prefix}store2`,buttonText:{displayText: `Command`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `PAYMENT`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Maaf Kalau Menu Store Sedikit.\nSilahkan Request Fitur ke Owner', imageMessage: imageMsg,
...
き⃟🦈 underwater text
き⃟🦈 golderrose text
き⃟🦈 summernature text
き⃟🦈 letterleaves text
き⃟🦈 glowingneon text
き⃟🦈 fallleaves text
き⃟🦈 flamming text
き⃟🦈 harrypotter text
き⃟🦈 carvedwood text
き⃟🦈 tiktok text1 text2
き⃟🦈 arcade8bit text1 text2
き⃟🦈 battlefield4 text1 text2
き⃟🦈 pubg text1 text2
...
き⃟🦈 wetglass text
き⃟🦈 multicolor3d text
き⃟🦈 watercolor text
き⃟🦈 luxurygold text
き⃟🦈 galaxywallpaper text
き⃟🦈 lighttext text
き⃟🦈 beautifulflower text
き⃟🦈 puppycute text
き⃟🦈 royaltext text
き⃟🦈 heartshaped text
き⃟🦈 birthdaycake text
き⃟🦈 galaxystyle text
き⃟🦈 hologram3d text
き⃟🦈 greenneon text
き⃟🦈 glossychrome text
き⃟🦈 greenbush text
き⃟🦈 metallogo text
き⃟🦈 noeltext text
き⃟🦈 glittergold text
...
き⃟🦈 snow3d text
き⃟🦈 birthdayday text
き⃟🦈 goldplaybutton text
き⃟🦈 silverplaybutton text
き⃟🦈 freefire text
...
き⃟🦈  ꜱᴇᴛᴘᴘɢʀᴜᴘ
き⃟🦈  ꜱᴇᴛᴅᴇꜱᴄ
き⃟🦈  ꜱɪᴅᴇʀ *ʀᴇᴘʟʏ ᴄʜᴀᴛ ʙᴏᴛ*
き⃟🦈  ʜɪᴅᴇᴛᴀɢ *ᴛᴇᴋꜱ/ʀᴇᴘʟʏ ᴛᴇᴋꜱ*
...
`
 ...
 𝐋𝐈𝐒𝐓 𝐌𝐄𝐍𝐔
き⃟🦈 ${prefix}drakorongoing
き⃟🦈 ${prefix}lk21 query
き⃟🦈 ${prefix}wattpad url_wattpad
き⃟🦈 ${prefix}wattpadsearch query
き⃟🦈 ${prefix}cerpen
き⃟🦈 ${prefix}ceritahoror
...
`
 ...
 𝐋𝐈𝐒𝐓 𝐌𝐄𝐍𝐔
き⃟🦈 ${prefix}quotes
き⃟🦈 ${prefix}quotesdiLan
き⃟🦈 ${prefix}quotesanime
き⃟🦈 ${prefix}quotesimage
き⃟🦈 ${prefix}faktaunik
き⃟🦈 ${prefix}katabijak
き⃟🦈 ${prefix}pantun
き⃟🦈 ${prefix}bucin
き⃟🦈 ${prefix}randomnama
...
`
 ...
 𝐋𝐈𝐒𝐓 𝐌𝐄𝐍𝐔
き⃟🦈 ${prefix}dropwater *teks*
き⃟🦈 ${prefix}blueneon *teks*
き⃟🦈 ${prefix}flowertext *teks*
き⃟🦈 ${prefix}tlight *teks*
き⃟🦈 ${prefix}epep *teks*
き⃟🦈 ${prefix}nulis *teks*
き⃟🦈 ${prefix}nulis2 *teks*
き⃟🦈 ${prefix}splaybutton *teks*
き⃟🦈 ${prefix}gplaybutton *teks*
き⃟🦈 ${prefix}cslogo *teks*
き⃟🦈 ${prefix}crismes *teks*
き⃟🦈 ${prefix}text3d *teks*
き⃟🦈 ${prefix}matrix *teks*
き⃟🦈 ${prefix}tfire *teks*
き⃟🦈 ${prefix}naruto *teks*
き⃟🦈 ${prefix}breakwall *teks*
き⃟🦈 ${prefix}flametext *teks*
き⃟🦈 ${prefix}sandw *teks*
...
き⃟🦈  ${prefix}slow
き⃟🦈  ${prefix}leaveall
き⃟🦈  ${prefix}join *link gc*
き⃟🦈  ${prefix}shutdown
き⃟🦈  ${prefix}getquoted
き⃟🦈  ${prefix}addupdate *fiturnya*
き⃟🦈  ${prefix}exif *nama|author*
き⃟🦈  ${prefix}sewa add/del *waktunya*
き⃟🦈  ${prefix}premium add @tag|nomor
き⃟🦈  ${prefix}premium del @tag|nomor
...
き⃟🦈  ${prefix}megumin
き⃟🦈  ${prefix}otakudesu
き⃟🦈  ${prefix}doujindesu
き⃟🦈  ${prefix}storyanime
き⃟🦈  ${prefix}nakanomiku
き⃟🦈  ${prefix}nakanoikyy
き⃟🦈  ${prefix}nakanoitsuki
き⃟🦈  ${prefix}otakuongoing
き⃟🦈  ${prefix}nhentai *code*
き⃟🦈  ${prefix}nekopoi *link*
...
き⃟🦈  ${prefix}shopee *product*
き⃟🦈  ${prefix}playstore *query*
き⃟🦈  ${prefix}ssweb *query*
き⃟🦈  ${prefix}google *query*
き⃟🦈  ${prefix}image *query*
き⃟🦈  ${prefix}pinterest *query*
き⃟🦈  ${prefix}iguser *ussername*
き⃟🦈  ${prefix}igstalk *username*
き⃟🦈  ${prefix}githubstalk *username*
き⃟🦈  ${prefix}tiktokstalk *ussername*
き⃟🦈  ${prefix}img2url *reply foto*
...
き⃟🦈  ${prefix}suit *batu/kertas/gunting*
 `
...
き⃟🦈  ${prefix}semoji *emoji*
き⃟🦈  ${prefix}sticker *reply foto/video*
き⃟🦈  ${prefix}smeme *teks|teks*
き⃟🦈  ${prefix}swm *pack|author*
き⃟🦈  ${prefix}take *pack|author* 
き⃟🦈  ${prefix}tovideo *reply sgif*
...
き⃟🦈  ${prefix}mining
き⃟🦈  ${prefix}cekwatak
き⃟🦈  ${prefix}cekmati [nama]
き⃟🦈  ${prefix}wangy [nama]
き⃟🦈 ${prefix}bismilah [tujuan]
き⃟🦈  ${prefix}citacita
き⃟🦈  ${prefix}toxic
き⃟🦈  ${prefix}truth
き⃟🦈  ${prefix}dare
...
`
 ...
 Putra Store︎`, imageMessage: imageMsg,
   ...
   case 'command':
               list = []
               listmenu = [`allmenu`,`runtime`,`status`,`groupmenu`,`photoxy`,`makermenu`,`ephoto`,`randomimage`,`wibu2`,`storymenu`,`porno`,`randomtext`,`islammenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`gcmikel`,`sewabot`,`info`,`store`,]
               listmenuu = [`All Menu Bot`,`Runtime`,`Status Bot`,`Menu Group`,`Photo Oky`,`Image Maker`,`Ephoto Menu`,`Random Image`,`Nsfw Anime`,`Movie&Story`,`18+ Menu`,`RandomText`,`Islam Menu`,`Wibu Menu`,`Sticker Menu`,`Owner Command`,`Game Menu`,`For Fun Menu`,`Downloader`,`Info Menu`,`Menu Lainnya`,`OwnerBot`,`Official Group`,`Rent this Bot`,`Thanks To`,`Store Putra Bot`,]
               nombor = 1
               startnum = 0
               ...
               case 'store2':
               list = []
               listmenu = [`sewabot`,`diamondml`,`diamondff`,`ucpubg`,]
               listmenuu = [`Sewa Bot`,`Diamonds Mobille legends`,`Diamonds Free Fire`,`UC ucpubg`,]
               nombor = 1
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'menu ke' + nombor++,
               ...
               case 'diamondml':
              gopeynya = 'https://telegra.ph/file/bff3bb3041a0d17d1ce21.jpg'
            buff = await getBuffer(gopeynya)
            teksnya = `◁━━━━◈✙◈━━━━▷
List Harga Diamond Ml
3 diamonds💎	1.500.
12 diamonds💎  3.325.
28 diamonds💎  7.600.
36 diamonds💎  9.500.
...
━━━━━━━ •♬• ━━━━━━━
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `OWNER`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `PAYMENT`},type:1},{buttonId: `${prefix}rules`,buttonText:{displayText: `S&K`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              ...
              break
              case 'diamondff':
              gopeynya = 'https://telegra.ph/file/f99a4bda2cb2080e85f85.jpg'
            buff = await getBuffer(gopeynya)
            teksnya = `◁━━━━◈✙◈━━━━▷
...
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `OWNER`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `PAYMENT`},type:1},{buttonId: `${prefix}rules`,buttonText:{displayText: `S&K`},type:1}]
              ...
              break
              case 'ucpubg':
              gopeynya = 'https://telegra.ph/file/3a2a42d0499345cdeb7f7.jpg'
            buff = await getBuffer(gopeynya)
            teksnya = `◁━━━━◈✙◈━━━━▷
List Harga UC Pubg
💵50	Rp 20.000
...
━━━━━━━ •♬• ━━━━━━━
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `Owner`},type:1},{buttonId: `${prefix}command`,buttonText:{displayText: `BackTo Menu`},type:1},{buttonId: `${prefix}rules`,buttonText:{displayText: `S&K`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'PUTRA BOT', imageMessage: imageMsg,
              contentText: teksnya,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
...
き⃟🦈️ ${prefix}gelud @tag
き⃟🦈️ ${prefix}tictactoe @tag
...
き⃟🦈️ ${prefix}suit *batu/kertas/gunting*
...
き⃟🦈️ ${prefix}cekmati [nama]
き⃟🦈️ ${prefix}wangy [nama]
...
き⃟🦈️ ${prefix}brainly *query*
き⃟🦈️ ${prefix}shopee *product*
き⃟🦈️ ${prefix}playstore *query*
き⃟🦈️ ${prefix}ssweb *query*
き⃟🦈️ ${prefix}google *query*
き⃟🦈️ ${prefix}image *query*
き⃟🦈️ ${prefix}pinterest *query*
き⃟🦈️ ${prefix}nulis *teks*
き⃟🦈️ ${prefix}iguser *ussername*
き⃟🦈️ ${prefix}igstalk *username*
き⃟🦈️ ${prefix}githubstalk *username*
き⃟🦈️ ${prefix}tiktokstalk *ussername*
き⃟🦈️ ${prefix}img2url *reply foto*
き⃟🦈️ ${prefix}ytsearch *query*
...
き⃟🦈️ ${prefix}toimg
き⃟🦈️ ${prefix}patrick
き⃟🦈️ ${prefix}garwgura
き⃟🦈️ ${prefix}ttg *teks*
き⃟🦈️ ${prefix}attp *teks*
き⃟🦈️ ${prefix}stickeranime
き⃟🦈️ ${prefix}semoji *emoji*
き⃟🦈️ ${prefix}sticker *reply foto/video*
き⃟🦈️ ${prefix}smeme *teks|teks*
き⃟🦈️ ${prefix}swm *pack|author*
き⃟🦈️ ${prefix}take *pack|author* 
き⃟🦈️ ${prefix}tovideo *reply sgif*
...
き⃟🦈️ ${prefix}nakanomiku
き⃟🦈️ ${prefix}nakanonino
き⃟🦈️ ${prefix}nakanoitsuki
き⃟🦈️ ${prefix}otakuongoing
き⃟🦈️ ${prefix}nhentai *code*
き⃟🦈️ ${prefix}nekopoi *link*
...
き⃟🦈️ ${prefix}join *link gc*
き⃟🦈️ ${prefix}shutdown
き⃟🦈️ ${prefix}getquoted
き⃟🦈️ ${prefix}addupdate *fiturnya*
き⃟🦈️ ${prefix}exif *nama|author*
き⃟🦈️ ${prefix}sewa add/del *waktunya*
き⃟🦈️ ${prefix}premium add @tag|nomor
き⃟🦈️ ${prefix}premium del @tag|nomor


  # GROUP-MENU

き⃟🦈️ ${prefix}groupsetting
き⃟🦈️ ${prefix}afk *alasan*
き⃟🦈️ ${prefix}ceksewa
き⃟🦈️ ${prefix}kickall
...
き⃟🦈️ ${prefix}tagall *teks*
き⃟🦈️ ${prefix}leave
き⃟🦈️ ${prefix}kick *reply*
き⃟🦈️ ${prefix}add *+62xxxxxx*
き⃟🦈️ ${prefix}setgrupname
き⃟🦈️ ${prefix}setppgrup
き⃟🦈️ ${prefix}setdesc
き⃟🦈️ ${prefix}sider *reply chat bot*
き⃟🦈️ ${prefix}hidetag *teks/reply teks*
...
き⃟🦈️ ${prefix}sourcecode
き⃟🦈️ ${prefix}bugreport *keluhan*

━━━━━━━ •♬• ━━━━━━━
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `Owner🐣`},type:1},{buttonId: `${prefix}command`,buttonText:{displayText: `Back To Menu🐣`},type:1},{buttonId: `${prefix}sewabot`,buttonText:{displayText: `Sewa Bot🐣`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'PUTRA BOT', imageMessage: imageMsg,
              contentText: teksnya,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
...
━━━━━━━ •♬• ━━━━━━━
`
  buttons = [{buttonId: `${prefix}kemren`,buttonText:{displayText: `Kemren Banh`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'PUTRA BOT', imageMessage: imageMsg,
              contentText: teksnya,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport': 
              ...
              ikyy.sendMessage('6283866844016@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'jawaban':
       ...
       case 'request':
              ...
              ikyy.sendMessage('6283866844016@s.whatsapp.net',`*Request:* ${teks}`, text)
              break
case 'chatrava':
              if (args.length < 1) return reply(`Ketik ${prefix}CHAT [CHAT apa]`) 
              teks = args.join(' ')
              reply('CHAT RAVA DONE')
              ikyy.sendMessage('6283866844016@s.whatsapp.net',`*chat:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Menunya Bang:v >-------------------
      ...
      break
      case 'jadibot':
             if (!isUser) return  reply(mess.only.owner)
