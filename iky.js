...
ikyy.sendMessage(from, loli, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                    ikyy.sendMessage(from, { contentText: `${menu}`, footerText: 'Jika Button Di Bawah Tidak Muncul, silahkan Ketik  !command', buttons: [{ buttonId: `!command`, buttonText: { displayText: '☰ COMMAND' }, type: 1 },{ buttonId: `!fitur`, buttonText: { displayText: '☰ OWNER BOT' }, type: 1 },{ buttonId: `!sewabot`, buttonText: { displayText: '☰  SEWA BOT' }, type: 1 },{ buttonId: `!owner`, buttonText: { displayText: 'OWNER 👑' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'f':
case 'lock':
 ikymemek = {
